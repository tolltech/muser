...
namespace Tolltech.MuserUI.Controllers
{
    public class SpotifyTokenRefreshActionFilter  : Attribute, IActionFilter
    {
        ...
        public SpotifyTokenRefreshActionFilter(ISpotifyTokenService spotifyTokenService, ISpotifyTokenClient spotifyTokenClient, IAuthorizationSettings authorizationSettings)
        {
